import { speak } from './11labstest';
import { askGemini, chatWithContext } from './llmcall';
/**
 ...
 */
export async function gptConversationalResponse(prompt) {
 ...
 */
export async function runDriver(prompt) {
