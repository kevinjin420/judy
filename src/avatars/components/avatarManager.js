...
import { AvatarState } from '../types/avatar.js';
export class AvatarManager {
    ...
    loadAllCharacters() {
        try {
            ...
            const savedCharacter = vscode.workspace.getConfiguration('judy').get('currentCharacter');
    ...
    async createCharacter(character) {
        ...
        // Save character data
        fs.writeFileSync(path.join(characterDir, 'character.json'), JSON.stringify(character, null, 2));
        // Reload characters
        this.loadAllCharacters();
    }
}
